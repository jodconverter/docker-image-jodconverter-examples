build:
	...
	docker build --build-arg BASE_VERSION=0.0.1 --target rest . -t ghcr.io/eugenmayer/jodconverter-examples:rest

start-gui: stop
	docker run --name jodconverter-spring -m 512m --rm -p 8080:8080 ghcr.io/jodconverter/jodconverter-examples:gui
